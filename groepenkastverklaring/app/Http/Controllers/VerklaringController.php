...
class VerklaringController extends Controller
{
    ...
    public function edit(Verklaring $verklaring)
    {
    ...
    public function update(Request $request, Verklaring $verklaring)
    {
        if ($verklaring->user_id !== auth()->id()) {
            abort(403);
        }
    ...
    public function download(Verklaring $verklaring)
    {
        if ($verklaring->user_id !== auth()->id()) {
            abort(403);
        }
    ...
    public function destroy(Verklaring $verklaring)
    {
        if ($verklaring->user_id !== auth()->id()) {
            abort(403);
        }
